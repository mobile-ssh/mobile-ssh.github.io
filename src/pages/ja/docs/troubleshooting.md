...
- 秘密鍵欄に鍵を手動で貼り付けてみます。
- 鍵の種類が対応しているものであることを確認します。Android では Ed25519、RSA、ECDSA、DSA、iOS では Ed25519 または ECDSA（P-256/384/521）です。
...
iOS にはストレージ権限がありません。ローカル側のペインにはアプリのドキュメント領域が表示され、ファイルはシステムのドキュメント選択ツールや写真選択ツールから追加します。
