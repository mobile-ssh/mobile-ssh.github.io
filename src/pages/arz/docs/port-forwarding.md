...
Mobile SSH بيدعم إعادة توجيه منافذ SSH المحلية. بيتفتح منفذ محلي على جهاز Android بيسمع على `127.0.0.1` وبيعدّي الترافيك عبر اتصال SSH لمضيف ومنفذ بعيدين.
...
Mobile SSH بيربط عمليات التوجيه المحلية بـ `127.0.0.1` على جهاز Android. ده مقصود: بيخلّي النفق محلي على الجهاز وبيتجنّب أي مفاجآت ممكنة مع الـ loopback الخاص بـ IPv6 بس. تطبيقات تانية على نفس جهاز Android ممكن تتصل بالمنفذ المحلي المُعاد توجيهه لو Android سمح بوصولها للشبكة.
...
وبعدين افتح `http://127.0.0.1:8080` من أي متصفح على جهاز Android.
