...
Mobile SSH 係一款 Android SSH 用戶端，用嚟連線你自己嘅 Linux、Unix、網絡、IoT 或開發伺服器。你提供伺服器位址同憑證，應用程式就會開一個互動式 SSH 終端機。
...
Mobile SSH 跟隨 Android 系統語言。應用程式附帶阿拉伯文、孟加拉文、中文（簡體同繁體）、英文、法文、德文、印地文、印尼文、日文、馬拉地文、尼日利亞皮欽語、葡萄牙文、俄文、西班牙文、坦米爾文、泰盧固文、土耳其文同烏爾都文嘅翻譯。請喺 Android 嘅 **Settings → System → Languages** 更改語言，而唔係喺應用程式入面改。
