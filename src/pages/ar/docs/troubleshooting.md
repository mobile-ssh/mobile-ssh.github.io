...
إذا كانت لوحة المفاتيح على الشاشة تغيّر النص قبل وصوله إلى الصدفة، فعطّل اقتراحات لوحة المفاتيح في إعدادات Mobile SSH. هذا مفيد لـ Vim وtmux وhtop وless والصدفات التي تستخدم توليفات مفاتيح غير معتادة وموجّهات كلمات المرور البعيدة.
