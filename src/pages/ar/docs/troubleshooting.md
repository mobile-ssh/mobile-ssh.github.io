...
على iOS، يعلّق النظام التطبيقات في الخلفية، لذا لا يمكن إبقاء اتصال SSH خام مفتوحًا إلى أجل غير مسمى بعد التبديل عن التطبيق أو قفل الشاشة. تغطي مهلة سماح قصيرة عمليات التبديل السريعة بين التطبيقات؛ ولأي مدة أطول، فعّل **Auto-attach tmux session** في ملف تعريف الخادم (أو استخدم ناقل **Eternal Terminal**) بحيث تعيدك إعادة الاتصال إلى الصدفة نفسها حيث توقفت.
...
على iOS يعرض الجزء المحلي منطقة مستندات التطبيق، وتضيف الملفات عبر منتقيَي المستندات والصور في النظام. والتنزيلات هناك مرئية أيضًا في تطبيق «الملفات» ضمن **On My iPhone**.
