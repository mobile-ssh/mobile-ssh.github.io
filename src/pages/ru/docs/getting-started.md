...
Импорт закрытого ключа использует системное средство выбора файлов для файлов ключей. На Android передача файлов использует отдельный локальный файловый браузер и на новых версиях Android может запрашивать более широкий доступ к хранилищу; на iOS файлы поступают через системные средства выбора документов и фото.
...
- Просмотреть каталог доступных плагинов.
