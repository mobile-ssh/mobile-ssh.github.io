...
- Если доступ к хранилищу Android блокирует локальный просмотр, выдайте разрешение в настройках Android и снова откройте передачу файлов. На iOS вместо этого используйте средства выбора, чтобы добавить файлы на локальную панель.
