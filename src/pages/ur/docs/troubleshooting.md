...
title: "مسائل کا حل"
description: "کنکشن، توثیق، کی بورڈ، tmux، فائل منتقلی اور ٹنل مسائل کے لیے Mobile SSH مسائل کے حل کی گائیڈ۔"
---
...
Mobile SSH کی اسٹروکس کو خودکار درستی اور پیش گو تجاویز بند کر کے سیدھا شیل تک بھیجتا ہے، اس لیے کی بورڈ کو متن کو ریموٹ سرے تک پہنچنے سے پہلے دوبارہ نہیں لکھنا چاہیے (غیر فعال کرنے کے لیے کوئی تجاویز ترتیب نہیں ہے)۔ اگر آپ کا کی بورڈ پھر بھی ان پٹ بدلتا ہے تو تصدیق کریں کہ کوئی سسٹم-سطح کا متبادل یا کلپ بورڈ ٹول اسے نہیں روک رہا، اور `ESC`، `TAB`، `CTRL`، تیر، `HOME`، `END`، `PGUP` اور `PGDN` جیسی ٹرمینل کلیدوں کے لیے اضافی کلید قطار استعمال کریں۔
