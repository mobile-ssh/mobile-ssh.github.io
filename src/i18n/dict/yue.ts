...
export const yue: Dict = {
  ...
  compare: {
    ...
    agentAppsIntro:
      "有一類快速增長嘅 App，專門用嚟由你部電話驅動編碼代理 —— Claude Code、Codex 之類。有啲係第三方 SSH 或者中繼 App（Onepilot、Happy、Omnara、Moshi、Orca）；而家 OpenAI 同 Anthropic 都原生內建咗呢個功能，ChatGPT App 入面有 Codex，Claude App 入面有 Claude Code，兩者都喺供應商自己嘅雲端運行。Mobile SSH 同佢哋全部都有重疊 —— 你可以經 SSH 運行呢啲代理，喺佢哋需要你嗰陣收到提示 —— 但佢係由另一邊入手：佢首先係一個通用、直連嘅 SSH 用戶端，其次先至係代理夥伴。",
    agentAppsRows: [
      { feature: "由你部電話運行編碼代理",                mobile: "yes", onepilot: "yes",      happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "yes",         claude: "yes" },
      { feature: "適用於任何編碼代理（唔限於單一供應商）", mobile: "yes", onepilot: "yes",      happy: "Claude Code", omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "淨係 Codex",  claude: "淨係 Claude Code" },
      { feature: "喺你自己嘅機器上運行（唔係供應商雲端）",   mobile: "yes", onepilot: "yes",      happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "no",          claude: "部分" },
      { feature: "直連 SSH —— 冇雲端中繼",                  mobile: "yes", onepilot: "yes",      happy: "no",          omnara: "no", moshi: "yes", orca: "no",      chatgpt: "no",          claude: "no" },
      { feature: "通用 SSH 終端機（運行任何命令）",         mobile: "yes", onepilot: "yes",      happy: "no",          omnara: "部分", moshi: "yes", orca: "已配對電腦嘅終端",    chatgpt: "no",          claude: "no" },
      { feature: "SFTP 檔案傳輸",                           mobile: "yes", onepilot: "部分",     happy: "no",          omnara: "no", moshi: "文件講法唔一致", orca: "淨係桌面版",      chatgpt: "no",          claude: "no" },
      { feature: "本機連接埠轉發",                            mobile: "yes", onepilot: "yes",      happy: "no",          omnara: "no", moshi: "開發預覽（Pro）", orca: "淨係桌面版",      chatgpt: "no",          claude: "no" },
      { feature: "tmux 工作階段管理器",                         mobile: "yes", onepilot: "部分",     happy: "no",          omnara: "no", moshi: "Pro", orca: "文件冇講明",      chatgpt: "no",          claude: "no" },
      { feature: "適用於你自己裝嘅代理",                  mobile: "yes", onepilot: "yes",      happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "no",          claude: "no" },
      { feature: "代理通知（已連線嘅代理需要你輸入時）",  mobile: "yes", onepilot: "yes",      happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "yes",         claude: "yes" },
      { feature: "一撳批准／拒絕代理提示",               mobile: "yes", onepilot: "yes",      happy: "yes",         omnara: "yes", moshi: "試用完要 Pro", orca: "支援嘅代理",     chatgpt: "yes",         claude: "yes" },
      { feature: "零伺服器或 SSH 設定",                     mobile: "no",  onepilot: "no",       happy: "部分",        omnara: "部分", moshi: "no", orca: "要同電腦配對",    chatgpt: "yes",         claude: "yes" },
      { feature: "Android 同 iOS",                          mobile: "yes", onepilot: "淨係 iOS", happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "yes",         claude: "yes" },
      { feature: "唔需要帳號",                              mobile: "yes", onepilot: "yes",      happy: "yes",         omnara: "no", moshi: "yes", orca: "LAN/Tailscale；Relay 要帳戶",      chatgpt: "no",          claude: "no" },
      { feature: "冇 Pro paywall（所有功能免費）",          mobile: "yes", onepilot: "no",       happy: "no",          omnara: "no", moshi: "no", orca: "yes",      chatgpt: "免費版",      claude: "no" },
      { feature: "開源",                                    mobile: "Apache 2.0",  onepilot: "no",       happy: "MIT",         omnara: "Apache", moshi: "no", orca: "MIT",  chatgpt: "no",          claude: "no" }
    ],
    agentAppsNote:
