...
export const yue: Dict = {
  ...
  features: {
    ...
    groups: [
      ...
      },
      {
        title: "金鑰與備份",
        items: [
          "喺裝置上產生新嘅 Ed25519、ECDSA 或 RSA 金鑰，可選密碼短語",
  ...
  compare: {
    ...
    featureRows: [
      ...
      { category: "終端機", feature: "附加按鍵列（ESC/TAB/CTRL/…）",     mobile: "yes",    termux: "部分",      termius: "yes" },
      ...
      { category: "會話", feature: "多個同時 SSH 會話",                   mobile: "最多 8 個", termux: "經由 tmux",    termius: "yes" },
      { category: "會話", feature: "格仔面板佈局",                        mobile: "yes",    termux: "no",           termius: "標籤頁" },
      ...
      { category: "會話", feature: "前景服務同 wake lock",                mobile: "yes",    termux: "部分",      termius: "yes" },
      ...
      { category: "備份", feature: "匯出／匯入伺服器備份",                mobile: "yes",    termux: "no",           termius: "雲端保險庫" },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "匿名使用分析", body: "為咗了解應用程式點樣被使用並加以改善，Mobile SSH 會向 Aptabase（一間注重私隱、代表我哋處理資料嘅分析服務商）傳送匿名使用分析。僅限匿名事件（例如應用程式開啟同所用功能），連同應用程式版本、Android 版本、裝置型號同語言。佢使用會定期重設嘅隨機工作階段識別碼，唔會同你或你嘅裝置關聯。當中絕不包含你嘅 SSH 伺服器、主機名稱、用戶名、密碼、金鑰、指令或檔案內容。資料透過加密（HTTPS）連線傳送。分析預設開啟，可隨時喺「設定」入面關閉；關閉後唔會傳送任何嘢。" }
    ],
