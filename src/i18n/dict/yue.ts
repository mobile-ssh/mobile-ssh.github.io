...
export const yue: Dict = {
  ...
  home: {
    ...
    videoIosAlt: "iOS 示範：打開 Mobile SSH 直接入到運行中嘅 SSH 終端機工作階段，跟住返去主畫面，睇到「最近」同 app 其他畫面",
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          "以「續返之前嘅嘢」為中心嘅主畫面：而家仲連緊嘅連線，同埋喺你伺服器上面等緊嘅 tmux 工作階段 —— 佢哋由已儲存嘅快照嚟，所以冇網絡都列得出，每一行仲會標明個快照幾耐之前。iOS 仲會保留一個「最近」清單",
