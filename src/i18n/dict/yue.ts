...
export const yue: Dict = {
  ...
  home: {
    ...
    demoIntro:
      "呢三段暫時仲未有 iOS 版本。同上面啲示範用同一部真實伺服器：一個就算你撥走個 App 都仲行緊嘅會話、一條喺電話上面產生而唔係打入去嘅密鑰，同埋按你自己諗嘢嗰個分法歸類好嘅伺服器。",
    demoItems: [
      {
        title: "撥走個 App，會話照樣行",
        ...
        androidAlt:
          "Android 示範一個喺背景繼續行嘅會話：終端機入面串流緊嘅即時 HTTP 日誌、通知權限提示、寫住已連線伺服器名同「全部中斷連線」嘅持續通知，跟住返去電話主畫面，返嚟見到同一條串流仲喺度到緊。"
      },
      {
        title: "密鑰喺呢度產生，唔係打入去",
        text: "喺電話上面產生一條 Ed25519 密鑰：一個標籤、一個用戶名、一個可選嘅密碼短語。跟住彈出嘅面板會顯示公鑰嗰半，畀你加入伺服器嘅 authorized_keys；公鑰同私鑰兩半都可以分享或者儲存。",
        androidAlt:
          "Android 示範產生密鑰：「產生 SSH 密鑰」對話框有標籤、用戶名、Ed25519 密鑰類型同密碼短語，跟住係公鑰面板，可以分享或者儲存條密鑰。"
      },
      {
        title: "伺服器擺喺你自己改名嘅資料夾入面",
        text: "將已儲存嘅伺服器整理入資料夾，唔用嗰啲就摺埋佢。同一段片最後去到終端機：指令印出嚟嘅 URL 會有底線，㩒一下就得，唔使自己用手揀。",
        androidAlt:
          "Android 示範伺服器資料夾：已儲存嘅伺服器分入有名嘅資料夾，可以展開同摺埋，跟住係終端機，指令輸出入面嘅 URL 有底線，可以㩒。"
      }
    ],
