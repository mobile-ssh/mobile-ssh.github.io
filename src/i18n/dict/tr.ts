...
export const tr: Dict = {
  ...
  compare: {
    ...
    featureRows: [
      ...
      { category: "Terminal",  feature: "Ek tuş satırı (ESC/TAB/CTRL/…)",            mobile: "yes",    termux: "kısmi",      termius: "yes" },
      ...
      { category: "Oturumlar", feature: "Eşzamanlı birden çok SSH oturumu",          mobile: "en fazla 8", termux: "tmux ile",   termius: "yes" },
      { category: "Oturumlar", feature: "Izgara panel düzeni",                       mobile: "yes",    termux: "no",           termius: "sekmeler" },
      ...
      { category: "Oturumlar", feature: "Ön plan servisi ve wake lock",              mobile: "yes",    termux: "kısmi",      termius: "yes" },
      ...
      { category: "Yedekleme", feature: "Sunucu yedeğini dışa / içe aktar",         mobile: "yes",    termux: "no",           termius: "bulut kasası" },
