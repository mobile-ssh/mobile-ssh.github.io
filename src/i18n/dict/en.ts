...
export const en: Dict = {
  ...
  compare: {
    ...
    featureRows: [
      { category: "Connection", feature: "Saved server profiles",               mobile: "yes",    termux: "no",           termius: "yes" },
      ...
      { category: "Terminal",   feature: "Tappable URLs in terminal output",    mobile: "yes",    termux: "no",           termius: "yes" },
      { category: "Terminal",   feature: "Text selection: copy / share / select all", mobile: "yes", termux: "yes",      termius: "yes" },
      { category: "Terminal",   feature: "Gboard suggestions & voice input",    mobile: "yes",    termux: "no",           termius: "yes" },
      { category: "Sessions",   feature: "Multiple concurrent SSH sessions",    mobile: "up to 8", termux: "via tmux",   termius: "yes" },
      ...
      { category: "Sessions",   feature: "tmux reattach hints on reconnect",   mobile: "yes",    termux: "yes",          termius: "no" },
      { category: "Sessions",   feature: "Agent alerts (Claude Code / Codex)", mobile: "yes",    termux: "no",           termius: "no" },
      { category: "Sessions",   feature: "Ongoing notification with session list", mobile: "yes", termux: "no",          termius: "no" },
      { category: "Sessions",   feature: "Foreground service & wake lock",     mobile: "yes",    termux: "partial",      termius: "yes" },
      { category: "Sessions",   feature: "Auto-reconnect with backoff",        mobile: "yes",    termux: "no",           termius: "yes" },
      ...
      { category: "Tunnels",    feature: "Saved tunnels with server profile",  mobile: "yes",    termux: "no",           termius: "yes" },
      ...
      { category: "Backup",     feature: "No account required",               mobile: "yes",    termux: "yes",          termius: "no" },
  ...
  privacy: {
    ...
    securityBody:
      "Protect your device with a strong screen lock if you save credentials or private keys. Only connect to servers you trust. The current implementation uses local app storage (and the iOS Keychain) rather than a separate encrypted cloud vault.",
