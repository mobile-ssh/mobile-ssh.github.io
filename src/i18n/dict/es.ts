...
export const es: Dict = {
  ...
  compare: {
    ...
    featureRows: [
      ...
      { category: "Terminal",          feature: "Fila de teclas extra (ESC/TAB/CTRL/…)",             mobile: "yes",     termux: "parcial",      termius: "yes" },
      ...
      { category: "Sesiones",          feature: "Varias sesiones SSH simultáneas",                   mobile: "hasta 8", termux: "mediante tmux",     termius: "yes" },
      { category: "Sesiones",          feature: "Disposición en cuadrícula",                         mobile: "yes",     termux: "no",           termius: "pestañas" },
      ...
      { category: "Sesiones",          feature: "Servicio en primer plano y wake lock",              mobile: "yes",     termux: "parcial",      termius: "yes" },
      ...
      { category: "Copia de seguridad", feature: "Exportar / importar copia de seguridad",          mobile: "yes",     termux: "no",           termius: "bóveda en la nube" },
