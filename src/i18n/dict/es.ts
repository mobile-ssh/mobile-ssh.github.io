...
export const es: Dict = {
  ...
  compare: {
    ...
    agentAppsIntro:
      "Existe una categoría de apps en rápido crecimiento creadas solo para manejar agentes de programación — Claude Code, Codex y similares — desde tu teléfono. Algunas son apps de terceros de SSH o de relé (Onepilot, Happy, Omnara, Moshi, Orca); OpenAI y Anthropic ahora también lo ofrecen de forma nativa, con Codex dentro de la app ChatGPT y Claude Code dentro de la app Claude, ambos ejecutándose en la propia nube del proveedor. Mobile SSH se solapa con todas ellas — puedes ejecutar esos agentes por SSH y recibir alertas cuando te necesitan — pero aborda la tarea desde el otro lado: es ante todo un cliente SSH general y directo, y en segundo lugar un compañero para agentes.",
    agentAppsRows: [
      { feature: "Ejecuta agentes de programación desde tu teléfono",              mobile: "yes", onepilot: "yes",       happy: "yes",        omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "yes",              claude: "yes" },
      { feature: "Funciona con cualquier agente de programación (no de un solo proveedor)", mobile: "yes", onepilot: "yes", happy: "Claude Code", omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "Solo Codex",       claude: "Solo Claude Code" },
      { feature: "Se ejecuta en tu propia máquina (no en la nube de un proveedor)", mobile: "yes", onepilot: "yes",       happy: "yes",        omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "no",               claude: "parcial" },
      { feature: "SSH directo — sin relé en la nube",                             mobile: "yes", onepilot: "yes",       happy: "no",         omnara: "no", moshi: "yes", orca: "no",        chatgpt: "no",               claude: "no" },
      { feature: "Terminal SSH general (ejecuta cualquier comando)",              mobile: "yes", onepilot: "yes",       happy: "no",         omnara: "parcial", moshi: "yes", orca: "Terminal del ordenador vinculado",   chatgpt: "no",               claude: "no" },
      { feature: "Transferencia de archivos SFTP",                                mobile: "yes", onepilot: "parcial",   happy: "no",         omnara: "no", moshi: "Documentación contradictoria", orca: "Solo en ordenador",        chatgpt: "no",               claude: "no" },
      { feature: "Reenvío local de puertos",                                      mobile: "yes", onepilot: "yes",       happy: "no",         omnara: "no", moshi: "Vistas previas de desarrollo (Pro)", orca: "Solo en ordenador",        chatgpt: "no",               claude: "no" },
      { feature: "Gestor de sesiones de tmux",                                    mobile: "yes", onepilot: "parcial",   happy: "no",         omnara: "no", moshi: "Pro", orca: "Sin documentar",        chatgpt: "no",               claude: "no" },
      { feature: "Funciona con un agente que hayas instalado tú",                 mobile: "yes", onepilot: "yes",       happy: "yes",        omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "no",               claude: "no" },
      { feature: "Avisos del agente (cuando un agente conectado necesita tu respuesta)", mobile: "yes", onepilot: "yes",   happy: "yes",        omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "yes",              claude: "yes" },
      { feature: "Aprobar/denegar las solicitudes del agente con un toque",       mobile: "yes", onepilot: "yes",       happy: "yes",        omnara: "yes", moshi: "Pro tras la prueba", orca: "Agentes compatibles",       chatgpt: "yes",              claude: "yes" },
      { feature: "Cero configuración de servidor o SSH",                          mobile: "no",  onepilot: "no",        happy: "parcial",    omnara: "parcial", moshi: "no", orca: "Vinculación con ordenador",   chatgpt: "yes",              claude: "yes" },
      { feature: "Android e iOS",                                                 mobile: "yes", onepilot: "Solo iOS",  happy: "yes",        omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "yes",              claude: "yes" },
      { feature: "Sin cuenta requerida",                                          mobile: "yes", onepilot: "yes",       happy: "yes",        omnara: "no", moshi: "yes", orca: "LAN/Tailscale; Relay requiere una cuenta",        chatgpt: "no",               claude: "no" },
      { feature: "Sin muro de pago Pro (todas las funciones gratis)",             mobile: "yes", onepilot: "no",        happy: "no",         omnara: "no", moshi: "no", orca: "yes",        chatgpt: "plan gratuito",    claude: "no" },
      { feature: "Código abierto",                                                mobile: "Apache 2.0",  onepilot: "no",        happy: "MIT",        omnara: "Apache", moshi: "no", orca: "MIT",    chatgpt: "no",               claude: "no" }
    ],
    agentAppsNote:
    ...
    agentAppsSourcesNote: "Verificado el 2026-09-19. El terminal SSH directo de Moshi es independiente de su servicio opcional para eventos y aprobaciones de agentes. Su ficha de Android anuncia SFTP, pero su documentación detallada describe subidas por SCP y vistas previas de servidores de desarrollo; esas celdas incluyen las salvedades correspondientes. La app móvil de Orca se vincula con Orca en un ordenador: LAN/Tailscale pueden funcionar sin una cuenta de Orca, mientras que Relay la requiere. La tabla señala las funciones exclusivas del ordenador y las no documentadas. Fuentes oficiales:",
  },
  privacy: {
