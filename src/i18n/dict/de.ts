...
export const de: Dict = {
  ...
  compare: {
    ...
    agentAppsIntro:
      "Eine schnell wachsende Kategorie von Apps existiert einzig dafür, Coding-Agenten – Claude Code, Codex und Co. – vom Smartphone aus zu steuern. Einige sind Drittanbieter-SSH- oder Relay-Apps (Onepilot, Happy, Omnara, Moshi, Orca); OpenAI und Anthropic liefern das inzwischen auch nativ, mit Codex in der ChatGPT-App und Claude Code in der Claude-App, die beide in der Cloud des jeweiligen Anbieters laufen. Mobile SSH überschneidet sich mit ihnen allen – du kannst diese Agenten über SSH ausführen und wirst benachrichtigt, wenn sie dich brauchen –, geht die Aufgabe aber von der anderen Seite an: Es ist zuerst ein allgemeiner, direkter SSH-Client und erst danach ein Agenten-Begleiter.",
    agentAppsRows: [
      { feature: "Führt Coding-Agenten vom Smartphone aus",                   mobile: "yes", onepilot: "yes",      happy: "yes",        omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "yes",             claude: "yes" },
      { feature: "Funktioniert mit jedem Coding-Agenten (nicht nur einem Anbieter)", mobile: "yes", onepilot: "yes", happy: "Claude Code", omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "nur Codex",       claude: "nur Claude Code" },
      { feature: "Läuft auf deinem eigenen Rechner (nicht in einer Anbieter-Cloud)", mobile: "yes", onepilot: "yes", happy: "yes",       omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "no",              claude: "teilweise" },
      { feature: "Direktes SSH – kein Cloud-Relay",                           mobile: "yes", onepilot: "yes",      happy: "no",         omnara: "no", moshi: "yes", orca: "no",        chatgpt: "no",              claude: "no" },
      { feature: "Allgemeines SSH-Terminal (beliebige Befehle ausführen)",    mobile: "yes", onepilot: "yes",      happy: "no",         omnara: "teilweise", moshi: "yes", orca: "Terminal des gekoppelten Computers", chatgpt: "no",              claude: "no" },
      { feature: "SFTP-Dateiübertragung",                                     mobile: "yes", onepilot: "teilweise", happy: "no",        omnara: "no", moshi: "Widersprüchliche Dokumentation", orca: "Nur auf dem Computer",        chatgpt: "no",              claude: "no" },
      { feature: "Lokale Portweiterleitung",                                  mobile: "yes", onepilot: "yes",      happy: "no",         omnara: "no", moshi: "Entwicklungsvorschauen (Pro)", orca: "Nur auf dem Computer",        chatgpt: "no",              claude: "no" },
      { feature: "tmux-Sitzungsmanager",                                      mobile: "yes", onepilot: "teilweise", happy: "no",        omnara: "no", moshi: "Pro", orca: "Nicht dokumentiert",        chatgpt: "no",              claude: "no" },
      { feature: "Funktioniert mit einem selbst installierten Agenten",       mobile: "yes", onepilot: "yes",      happy: "yes",        omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "no",              claude: "no" },
      { feature: "Agentenmeldungen (wenn ein verbundener Agent eine Eingabe benötigt)", mobile: "yes", onepilot: "yes", happy: "yes",   omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "yes",             claude: "yes" },
      { feature: "Ein-Tipp-Freigabe/-Ablehnung von Agenten-Anfragen",        mobile: "yes", onepilot: "yes",      happy: "yes",        omnara: "yes", moshi: "Pro nach der Testphase", orca: "Unterstützte Agenten",       chatgpt: "yes",             claude: "yes" },
      { feature: "Keine Server- oder SSH-Einrichtung",                        mobile: "no",  onepilot: "no",       happy: "teilweise",  omnara: "teilweise", moshi: "no", orca: "Kopplung mit einem Computer", chatgpt: "yes",             claude: "yes" },
      { feature: "Android und iOS",                                           mobile: "yes", onepilot: "nur iOS",  happy: "yes",        omnara: "yes", moshi: "yes", orca: "yes",       chatgpt: "yes",             claude: "yes" },
      { feature: "Kein Konto erforderlich",                                   mobile: "yes", onepilot: "yes",      happy: "yes",        omnara: "no", moshi: "yes", orca: "LAN/Tailscale; Relay benötigt ein Konto",        chatgpt: "no",              claude: "no" },
      { feature: "Keine Pro-Paywall (alle Funktionen kostenlos)",            mobile: "yes", onepilot: "no",       happy: "no",         omnara: "no", moshi: "no", orca: "yes",        chatgpt: "kostenlose Stufe", claude: "no" },
    ...
    agentAppsSourcesNote: "Geprüft am 2026-09-19. Moshis direktes SSH-Terminal ist von seinem optionalen Backend für Agentenereignisse und Freigaben getrennt. Der Android-Storeeintrag wirbt mit SFTP, die ausführliche Dokumentation beschreibt jedoch SCP-Uploads und Vorschauen von Entwicklungsservern; die betreffenden Zellen enthalten entsprechende Einschränkungen. Orcas mobile App wird mit Orca auf einem Computer gekoppelt: LAN/Tailscale können ohne Orca-Konto funktionieren, Relay benötigt dagegen eines. Funktionen, die nur auf dem Computer verfügbar oder nicht dokumentiert sind, sind in der Tabelle gekennzeichnet. Offizielle Quellen:",
  },
  privacy: {
