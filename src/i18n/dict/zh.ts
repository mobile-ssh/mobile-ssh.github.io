...
export const zh: Dict = {
  ...
  compare: {
    ...
    featureRows: [
      ...
      { category: "终端", feature: "SSH 终端",                        mobile: "yes",    termux: "via OpenSSH",  termius: "yes" },
      ...
      { category: "终端", feature: "拓展按键栏（ESC/TAB/CTRL/…）",   mobile: "yes",    termux: "partial",      termius: "yes" },
      ...
      { category: "会话", feature: "多个并发 SSH 会话",               mobile: "up to 8", termux: "via tmux",   termius: "yes" },
      { category: "会话", feature: "网格面板布局",                    mobile: "yes",    termux: "no",           termius: "tabs" },
      ...
      { category: "会话", feature: "前台服务与唤醒锁",                mobile: "yes",    termux: "partial",      termius: "yes" },
      ...
      { category: "文件", feature: "按名称或日期排序（按主机保存）",  mobile: "yes",    termux: "no",           termius: "partial" },
      { category: "隧道", feature: "本地端口转发",                    mobile: "yes",    termux: "via CLI",      termius: "yes" },
      ...
      { category: "密钥", feature: "设备上生成密钥",                  mobile: "yes",    termux: "via ssh-keygen", termius: "yes" },
      { category: "密钥", feature: "分享/保存生成的公钥",             mobile: "yes",    termux: "yes",          termius: "yes" },
      { category: "备份", feature: "导出/导入服务器备份",             mobile: "yes",    termux: "no",           termius: "cloud vault" },
      { category: "备份", feature: "加密本地备份文件",                mobile: "yes",    termux: "no",           termius: "no" },
      { category: "备份", feature: "无需账户",                        mobile: "yes",    termux: "yes",          termius: "no" },
      { category: "隐私与费用", feature: "无 Pro 付费墙",             mobile: "yes",    termux: "yes",          termius: "partial" },
