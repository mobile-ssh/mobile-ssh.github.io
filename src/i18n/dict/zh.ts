...
export const zh: Dict = {
  ...
  compare: {
    ...
    agentAppsSourcesNote: "核查日期：2026-09-19。Moshi 的直连 SSH 终端与其可选的智能体事件及审批后端是分开的。其 Android 商店页面宣称支持 SFTP，但详细文档描述的是 SCP 上传和开发服务器预览，因此表格中的相关单元格注明了限制。Orca 移动应用与电脑上的 Orca 配对：通过 LAN/Tailscale 连接可以不使用 Orca 账户，而 Relay 需要账户。仅限桌面端以及文档未说明的功能已在表格中标出。",
  },
  privacy: {
