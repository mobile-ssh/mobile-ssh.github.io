...
export const pt: Dict = {
  ...
  compare: {
    ...
    agentAppsIntro:
      "Existe uma categoria em rápido crescimento de apps criada apenas para conduzir agentes de programação — Claude Code, Codex e afins — a partir do seu celular. Alguns são apps SSH ou de retransmissão de terceiros (Onepilot, Happy, Omnara, Moshi, Orca); a OpenAI e a Anthropic agora também oferecem isso de forma nativa, com o Codex dentro do app ChatGPT e o Claude Code dentro do app Claude, ambos executando na nuvem do próprio fornecedor. O Mobile SSH se sobrepõe a todos eles — você pode executar esses agentes por SSH e receber alertas quando precisarem de você —, mas aborda a tarefa pelo outro lado: é primeiro um cliente SSH direto e de uso geral, e um complemento para agentes em segundo lugar.",
    agentAppsRows: [
      { feature: "Executa agentes de programação a partir do seu celular",         mobile: "yes", onepilot: "yes",        happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "yes",             claude: "yes" },
      { feature: "Funciona com qualquer agente de programação (não só um fornecedor)", mobile: "yes", onepilot: "yes",     happy: "Claude Code", omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "Apenas Codex",    claude: "Apenas Claude Code" },
      { feature: "Executa na sua própria máquina (não na nuvem de um fornecedor)",  mobile: "yes", onepilot: "yes",        happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "no",              claude: "parcial" },
      { feature: "SSH direto — sem retransmissão na nuvem",                         mobile: "yes", onepilot: "yes",        happy: "no",          omnara: "no", moshi: "yes", orca: "no",      chatgpt: "no",              claude: "no" },
      { feature: "Terminal SSH de uso geral (executa qualquer comando)",           mobile: "yes", onepilot: "yes",        happy: "no",          omnara: "parcial", moshi: "yes", orca: "Terminal do computador pareado", chatgpt: "no",              claude: "no" },
      { feature: "Transferência de arquivos SFTP",                                 mobile: "yes", onepilot: "parcial",    happy: "no",          omnara: "no", moshi: "Documentação contraditória", orca: "Somente no computador",      chatgpt: "no",              claude: "no" },
      { feature: "Encaminhamento local de portas",                                 mobile: "yes", onepilot: "yes",        happy: "no",          omnara: "no", moshi: "Prévias de desenvolvimento (Pro)", orca: "Somente no computador",      chatgpt: "no",              claude: "no" },
      { feature: "Gerenciador de sessões tmux",                                    mobile: "yes", onepilot: "parcial",    happy: "no",          omnara: "no", moshi: "Pro", orca: "Não documentado",      chatgpt: "no",              claude: "no" },
      { feature: "Funciona com um agente que você mesmo instalou",                 mobile: "yes", onepilot: "yes",        happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "no",              claude: "no" },
      { feature: "Alertas do agente (quando um agente conectado precisa de uma resposta)",    mobile: "yes", onepilot: "yes",        happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "yes",             claude: "yes" },
      { feature: "Aprovar/negar prompts do agente com um toque",                   mobile: "yes", onepilot: "yes",        happy: "yes",         omnara: "yes", moshi: "Pro após o período de teste", orca: "Agentes compatíveis",     chatgpt: "yes",             claude: "yes" },
      { feature: "Zero configuração de servidor ou SSH",                           mobile: "no",  onepilot: "no",         happy: "parcial",     omnara: "parcial", moshi: "no", orca: "Pareamento com computador", chatgpt: "yes",             claude: "yes" },
      { feature: "Android e iOS",                                                  mobile: "yes", onepilot: "Apenas iOS", happy: "yes",         omnara: "yes", moshi: "yes", orca: "yes",     chatgpt: "yes",             claude: "yes" },
      { feature: "Sem conta obrigatória",                                          mobile: "yes", onepilot: "yes",        happy: "yes",         omnara: "no", moshi: "yes", orca: "LAN/Tailscale; Relay exige conta",      chatgpt: "no",              claude: "no" },
      { feature: "Sem paywall Pro (todos os recursos gratuitos)",                  mobile: "yes", onepilot: "no",         happy: "no",          omnara: "no", moshi: "no", orca: "yes",      chatgpt: "nível gratuito",  claude: "no" },
      { feature: "Código aberto",                                                  mobile: "Apache 2.0",  onepilot: "no",         happy: "MIT",         omnara: "Apache", moshi: "no", orca: "MIT",  chatgpt: "no",              claude: "no" }
    ],
    agentAppsNote:
    ...
    agentAppsSourcesNote: "Verificado em 2026-09-19. O terminal SSH direto do Moshi é separado de seu serviço opcional para eventos e aprovações de agentes. A página do app Android anuncia SFTP, mas a documentação detalhada descreve uploads por SCP e prévias de servidores de desenvolvimento; essas células apresentam as ressalvas correspondentes. O app móvel do Orca é pareado com o Orca em um computador: LAN/Tailscale podem funcionar sem uma conta Orca, enquanto Relay exige uma. Recursos exclusivos do computador e recursos não documentados estão identificados na tabela. Fontes oficiais:",
  },
  privacy: {
    ...
    sections: [
      ...
      { heading: "Análise de uso", body: "Quando a análise está ativada, o Mobile SSH envia ao Aptabase interações com recursos (incluindo uso de VPN/proxy e tipo de multiplexador de terminal), diagnósticos de conexão, versões do aplicativo e do sistema operacional, modelo do dispositivo, idioma e um ID temporário de sessão por HTTPS para melhorar o aplicativo. O Aptabase processa o endereço IP e o User-Agent da solicitação para determinar o país ou a região e um identificador pseudônimo diário; ele não armazena o endereço IP original nem o User-Agent com os dados de análise. Os eventos não incluem tráfego de navegação, consultas DNS, endereços de servidores, nomes de usuário, credenciais, comandos nem conteúdo de arquivos. As versões Android com o aviso de consentimento para análise exigem aceitação explícita; versões Android anteriores e o iOS ativam a análise por padrão. Todos os recursos funcionam sem análise. As Configurações podem interromper a coleta; eventos já enfileirados ainda podem ser enviados no iOS. O consentimento no Android é local ao dispositivo e não é restaurado a partir de backups. Consulte o [acordo de processamento de dados do Aptabase](https://aptabase.com/legal/dpa)." },
      {
