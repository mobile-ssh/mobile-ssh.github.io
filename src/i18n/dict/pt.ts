...
export const pt: Dict = {
  ...
  home: {
    ...
    features: [
      { title: "Terminal SSH", text: "Terminal xterm-256color com cores reais de 24 bits, itálicos, pesquisa dentro do terminal, integração de shell via OSC 133 e ajuste de tamanho do texto por pinça — além de fonte e esquema de cores configuráveis e glifos powerline/de ícones da Nerd Font no Android." },
  ...
  features: {
    ...
    groups: [
      ...
      },
      {
        title: "Terminal",
        items: [
          "Comportamento de terminal estilo VT100/xterm-256color com cores reais de 24 bits e itálicos",
          "Buffer de scrollback de 5000 linhas, com tamanho configurável no Android",
          "Pesquisar no terminal — busque no scrollback e na tela visível e pule entre as correspondências (Android e iOS)",
          "Integração de shell (OSC 133): pule entre prompts, copie a saída de um comando e receba um alerta quando um comando de longa duração termina (Android e iOS)",
          "Imagens em linha no terminal via o protocolo gráfico Kitty (Android e iOS)",
          "Linha extra de teclas para ESC, TAB, CTRL, Shift, setas, Home, End, PgUp, PgDn e alternar teclado — personalizável no Android: adicione, remova, reordene e defina suas próprias teclas de sequência de escape, com redefinição para os padrões",
          ...
          "Área de transferência via OSC 52 — copie texto de uma sessão remota de tmux ou vim direto para a área de transferência do celular",
          ...
          "A Nerd Font incluída renderiza glifos de ícones powerline, starship, devicon e Material Design no Android que a fonte do sistema mostraria como quadrados vazios",
          ...
          "Fonte de terminal configurável (monoespaçada do sistema, JetBrains Mono ou Source Code Pro) e esquema de cores ANSI (Solarized, Gruvbox, Dracula, Nord) no Android, aplicados ao vivo aos painéis abertos"
        ]
      },
      {
        title: "Sessões",
        items: [
          ...
          "Alertas de agente: notificação com som e vibração opcionais quando um agente remoto (Claude Code, Codex, etc.) precisa de entrada — carregando o título e a mensagem do próprio agente via notificações OSC 9/777; toca no fone de ouvido durante vídeo",
      ...
      },
      {
        ...
        items: [
          ...
          "Abra um arquivo baixado em outro app no Android direto do painel local",
      ...
      },
      {
        title: "Segurança",
        items: [
          "Tela segura (Android): bloqueia capturas e gravação de tela e oculta o app da miniatura de recentes — uma opção que você ativa para quando senhas, chaves ou tokens estão na tela",
          ...
          "Apenas análises de uso anônimas, com opção de desativar — nunca seus servidores, credenciais, comandos ou conteúdo de arquivos"
        ]
      },
      {
        title: "Plugins",
  ...
  compare: {
    ...
    featureRows: [
      ...
      { category: "Terminal",           feature: "Buffer de scrollback de 5 000 linhas",               mobile: "yes",     termux: "configurável", termius: "yes" },
      ...
      { category: "Terminal",           feature: "Renderização de glifos Nerd Font / powerline",       mobile: "Android", termux: "configurável", termius: "parcial" },
      ...
      { category: "Túneis",             feature: "Adicionar / remover túneis em tempo real",           mobile: "Android", termux: "no",           termius: "yes" },
      ...
      { category: "Privacidade e custo", feature: "Tela segura (bloquear capturas de tela)",           mobile: "Android", termux: "no",           termius: "no" },
    ...
    agentAppsIntro:
      "Existe uma categoria mais recente de apps criada apenas para executar o Claude Code, o Codex e agentes de programação semelhantes em uma máquina remota a partir do seu celular. O Mobile SSH se sobrepõe a eles — você pode executar esses agentes por SSH e receber alertas quando precisarem de você —, mas aborda a tarefa pelo outro lado: é primeiro um cliente SSH direto e de uso geral, e um complemento para agentes em segundo lugar.",
    agentAppsRows: [
      { feature: "Executa Claude Code e Codex em um servidor remoto",     mobile: "yes",    onepilot: "yes",       happy: "yes",   omnara: "yes" },
      { feature: "Terminal SSH de uso geral (executa qualquer comando)",   mobile: "yes",    onepilot: "yes",       happy: "no",    omnara: "parcial" },
      { feature: "SSH direto — sem retransmissão na nuvem",                mobile: "yes",    onepilot: "yes",       happy: "no",    omnara: "no" },
      { feature: "Transferência de arquivos SFTP",                         mobile: "yes",    onepilot: "parcial",   happy: "no",    omnara: "no" },
      { feature: "Redirecionamento local de portas",                       mobile: "yes",    onepilot: "yes",       happy: "no",    omnara: "no" },
      { feature: "Gerenciador de sessões tmux",                            mobile: "yes",    onepilot: "parcial",   happy: "no",    omnara: "no" },
      { feature: "Alertas de agente (push quando o agente precisa de entrada)", mobile: "yes", onepilot: "yes",    happy: "yes",   omnara: "yes" },
      { feature: "Aprovar/negar prompts do agente com um toque",           mobile: "no",     onepilot: "yes",       happy: "yes",   omnara: "yes" },
      { feature: "Android e iOS",                                          mobile: "yes",    onepilot: "Apenas iOS", happy: "yes",  omnara: "yes" },
      { feature: "Sem conta obrigatória",                                  mobile: "yes",    onepilot: "yes",       happy: "yes",   omnara: "no" },
      { feature: "Sem paywall Pro (todos os recursos gratuitos)",          mobile: "yes",    onepilot: "no",        happy: "no",    omnara: "no" },
      { feature: "Código aberto",                                          mobile: "no",     onepilot: "no",        happy: "MIT",   omnara: "Apache" }
    ],
    agentAppsNote:
      "A troca é real: os apps dedicados a agentes adicionam uma tela de aprovar/negar com um toque para os prompts de permissão, enquanto o Mobile SSH faz você responder ao agente no terminal. Em troca, o Mobile SSH é um cliente completo de SSH/SFTP/túnel, conecta-se direto ao seu próprio servidor sem conta nem retransmissão de fornecedor, e todos os recursos são gratuitos. Happy e Omnara são de código aberto, mas passam por uma retransmissão na nuvem (o Omnara também exige uma conta); o Onepilot é o mais próximo — SSH direto no iOS —, mas apenas para iOS e pago.",
  },
  privacy: {
    ...
    securityBody:
      "Proteja seu dispositivo com bloqueio de tela forte se salvar credenciais ou chaves privadas. Conecte-se apenas a servidores confiáveis. A implementação atual usa armazenamento local do app (e o Keychain no iOS) em vez de um cofre criptografado em nuvem. No Android, uma opção de Tela segura bloqueia capturas e gravação de tela e oculta o app da tela de recentes.",
