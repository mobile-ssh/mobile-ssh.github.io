...
export const ja: Dict = {
  ...
  compare: {
    ...
    agentAppsRows: [
      ...
      { feature: "エージェント通知（接続中のエージェントが入力を必要とするとき）", mobile: "yes", onepilot: "yes", happy: "yes", omnara: "yes", chatgpt: "yes", claude: "yes" },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "匿名の使用状況分析", body: "Mobile SSH は匿名のアプリ・機能利用イベントを、アプリと OS のバージョン、端末モデル、言語とともに HTTPS で Aptabase に送信します。定期的に変わるランダムなセッション識別子を使い、サーバーアドレス、ユーザー名、認証情報、コマンド、ファイル内容は含みません。分析は初期状態で有効です。両プラットフォームの設定スイッチで新規イベントの収集を停止できますが、iOS ではすでにキューに入ったイベントが後から送信される場合があります。" },
      {
        "heading": "書き出すバックアップ",
