...
export const ja: Dict = {
  ...
  home: {
    ...
    features: [
      ...
      { title: "マルチプレクサー マネージャー", text: "プレフィックス キーを押さずに tmux を操作 — アタッチ、名前変更、作成、分割、ズーム、強制終了。Android では herdr と Zellij にも同じ操作が使え、ツールバーのアイコンはそのプログラムがサーバー上で見つかったときだけ現れます。" },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          "Android では herdr と Zellij のマネージャーも利用でき、それぞれのセッション、タブ、ペインに同じだけ手が届く — ツールバーのアイコンは、そのプログラムがサーバー上で見つかったときだけ表示される"
        ]
      },
      {
        title: "ファイルとトンネル",
  ...
  compare: {
    ...
    featureRows: [
      ...
      { category: "セッション", feature: "herdr と Zellij のセッション マネージャー",  mobile: "Android", termux: "CLI 経由",     termius: "no" },
