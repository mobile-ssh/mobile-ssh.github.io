...
export const ja: Dict = {
  ...
  compare: {
    ...
    featureRows: [
      ...
      { category: "ターミナル", feature: "拡張キーバー（ESC/TAB/CTRL/…）",      mobile: "yes",    termux: "一部対応",      termius: "yes" },
      ...
      { category: "セッション", feature: "複数の SSH 同時セッション",            mobile: "最大 8", termux: "tmux 経由",   termius: "yes" },
      { category: "セッション", feature: "グリッド ペイン レイアウト",           mobile: "yes",    termux: "no",           termius: "タブ" },
      ...
      { category: "セッション", feature: "フォアグラウンドサービスとウェイクロック", mobile: "yes", termux: "一部対応",    termius: "yes" },
      ...
      { category: "バックアップ", feature: "サーバー バックアップのエクスポート／インポート", mobile: "yes", termux: "no", termius: "クラウド保管庫" },
