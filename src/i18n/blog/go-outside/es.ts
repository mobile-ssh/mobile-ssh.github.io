...
export const es = defineGoOutside({
  ...
  body: [
    ...
    `La diferencia entre plataformas es real y conviene tenerla en cuenta. En Android, un servicio en primer plano mantiene la conexión mientras la app está en segundo plano: la notificación permanente <em>es</em> la sesión. iOS solo concede a la app un breve periodo en segundo plano; tras la suspensión, se reconecta y vuelve a conectarse a tu multiplexor cuando regresas. Las alertas dependen de que la conexión siga activa. En ambos casos, el agente del servidor nunca se detuvo, que es justo de lo que se trata. Solo se cerró la ventana.`,
  ...
  truth: {
    ...
    rows: [
      ...
      { item: "La conexión, en iOS", value: "Breve tiempo en segundo plano — luego se reconecta", survives: false },
      { item: "Una alerta sin cobertura para entregarla", value: "Necesita una conexión activa; la entrega no está garantizada", survives: false },
    ],
